  ...
  <div class="app-container">
    ...
    <div class="ccInfo">
      ...
      <div class="main">
        ...
        <p>
          <span>所属分类：{{ coursePublish.tier1Subject }} — {{ coursePublish.tier2Subject }}</span>
        </p>
...
export default {
  ...
  methods: {
    ...
    publish() {
      course.publish(this.$route.params.id).then(response => {
        this.$message({
          type: "success",
          message: "课程发布成功!"
        });
    ...
    fetchCoursePublishInfoById() {
      course.findCoursePublishVoById(this.$route.params.id).then(response => {
