<template>
  <div class="app-container">
    <el-form lable-width="120px">
      ...
      <el-upload ref="upload" name="multipartFile" :action="BASE_API+'/subject/import'" :auto-upload="false" :on-success="fileUploadSuccess" :on-error="fileUploadError"
        :disabled="importBtnDisable" accept="application/vnd.ms-excel">
